...
ActiveRecord::Schema[7.0].define(version: 2023_02_28_054145) do
  ...
  create_table "votes", force: :cascade do |t|
    ...
    t.index ["url_term_id", "url_category_id"], name: "index_votes_on_url_term_id_and_url_category_id", unique: true
